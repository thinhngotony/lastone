      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            buildTextField(phoneController,"Phone Numbers","Null", false),
            SizedBox(
              height: 35,
            ),
            Row(
              ...
              children: [
                ...
                RaisedButton(
                  onPressed: () async{
                    ...
                    await DatabaseService(uid: user.uid).updateUserProfile(nameController.text,emailController.text,phoneController.text);
                    //DocumentSnapshot snap =  DatabaseService(uid: user.uid).getProfileSnapshot;
